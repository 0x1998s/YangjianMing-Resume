...
- **AI agent 工程师/大模型LLM工程师** - LLM应用开发、Agent系统开发
...
### 🤖 [Rayneo AI Agent demo](./Rayneo-ai-agent/)
...
[📖 查看详细文档](./Rayneo-ai-agent/) | [🚀 在线演示](./Rayneo-ai-agent/docs/DEMO_SUMMARY.md)

---

### 🏢 [SaaS Agent - 电商多Agent协同平台](./SaasAgent/)
...
[📖 查看详细文档](./SaasAgent/) | [🎮 功能演示](./SaasAgent/docs/DEMO_GUIDE.md)

---

### 🏭 [TCL AI Agent - 数据分析demo](./tcl-ai-agent/)
...
[📖 查看详细文档](./tcl-ai-agent/) | [🔬 技术深度](./tcl-ai-agent/docs/DEMO_GUIDE.md)
